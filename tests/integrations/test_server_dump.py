...
def test_server_dump_all(server_with_data: Server):
    dump = server_with_data.dump()
...
def test_server_dump_things(server_with_data: Server):
    dump = server_with_data.dump(Thing)
...
def test_server_dump_datastreams_and_sensors(server_with_data: Server):
    dump = server_with_data.dump([Datastream, Sensor])
